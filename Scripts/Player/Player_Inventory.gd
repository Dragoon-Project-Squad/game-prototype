...
const SlotClass = preload("res://Scripts/UI/InventorySlot.gd")
const ItemClass = preload("res://Scripts/Objects/Item.gd")
const JsonData = preload("res://Scripts/UI/JSONData.gd")
const NUM_INVENTORY_SLOTS = 8

var active_item_slot = 0

var inventory = {
	0: ["Pistol", 1],  #--> slot_index: [item_name, item_quantity]
	1: ["Pistol", 1],  #--> slot_index: [item_name, item_quantity]
}
